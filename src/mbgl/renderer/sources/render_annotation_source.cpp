#include <mbgl/renderer/sources/render_annotation_source.hpp>
...
void RenderAnnotationSource::startRender(algorithm::ClipIDGenerator& generator, const mat4& matrix, const TransformState& transform) {
...
void RenderAnnotationSource::setObserver(TileObserver* observer) {
