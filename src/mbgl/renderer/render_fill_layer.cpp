...
RenderFillLayer::RenderFillLayer(std::shared_ptr<style::FillLayer::Impl> impl)
        : RenderLayer(style::LayerType::Fill, std::move(impl)),
          impl(static_cast<style::FillLayer::Impl *>(baseImpl.get())) {
}
